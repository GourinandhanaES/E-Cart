...
import { IncrementQuantity, removeItem , decrementQuantity, emptyCart } from '../redux/slices/cartSlice'
...
const Cart = () => {
  ...
  const checkOut = ()=>{
    dispatch(emptyCart())
    alert("Your order is confirmed...Thankyou for purchasing with us")
    navigate('/')
  }
