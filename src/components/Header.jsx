  ...
  return (
    <nav className='flex bg-violet-600 fixed w-full p-5 text-white font-bold'>
      ...
      <ul className='flex-1 text-right'>
        { insideHome && <li className='list-none inline-block px-5 text-black'><input style={{width:'300px'}} onChange={e=>dispatch(searchProduct(e.target.value.toLowerCase()))} className='rounded p-1' type="text" placeholder='Search Products Here!' /></li>}
